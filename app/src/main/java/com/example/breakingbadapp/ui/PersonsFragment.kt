...
import com.example.breakingbadapp.recyclerview.adapters.PersonAdapter
import com.example.breakingbadapp.ui.viewmodels.PersonViewModel
import com.example.breakingbadapp.viewModelFactory

class PersonsFragment: Fragment(R.layout.fragment_list) {
    ...
    private fun subToVm() {
        ...
        viewModel.infoToShow.observe(viewLifecycleOwner) {
            ...
            findNavController().navigate(
                ...
                PersonInfoFragmentArgs(it).toBundle(),
            )
        }
    }
}